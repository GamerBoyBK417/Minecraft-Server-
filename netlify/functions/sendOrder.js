export async function handler(event, context) {
  ...
  try {
    ...
    // --- Discord payload for Order ticket ---
    const discordPayload = {
      username: "Order Ticket",
    ...
    const emailPayload = {
      ...
      html: `
        <div style="font-family:Arial,Helvetica,sans-serif;color:#111;">
          ...
          <p>Your order ticket has been created successfully. Our team will get back to you within 24 hours.</p>
          ...
          <br>
          <a href="https://coramtix.in/orders" style="display:inline-block;padding:10px 20px;background:#0050A4;color:white;text-decoration:none;border-radius:6px;margin-right:10px;">
            View Order Status
          </a>
    ...
    return {
      statusCode: 200,
      headers: cors,
      body: JSON.stringify({ ok: true, message: "Order ticket created & email sent" }),
    };
  } catch (err) {
